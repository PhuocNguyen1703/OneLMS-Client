    ...
    <div className="flex">
      ...
      <div className="ml-5">
        ...
        <h5 className="text-gray-500 line-clamp-3">
          ...
          temporibus praesentium hic tenetur sapiente qui aliquam illum
          voluptatibus! Maxime eius quaerat obcaecati doloremque est cum
          provident beatae, ipsam vitae!
        </h5>
